            ...
            <div class="border-b border-slate-100 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="md:col-span-1">
                        ...
                        <input type="text" name="codigo" placeholder="Opcional" class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none uppercase font-bold text-sm transition">
                    </div>
                    <div class="md:col-span-3">
                        <label class="block text-[10px] font-black text-slate-500 uppercase mb-2">Nome Comercial</label>
                        <input type="text" name="nome" required class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none uppercase font-bold text-sm transition">
                    </div>
                </div>
            </div>
            ...
            <div class="border-b border-slate-100 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="calibre" required placeholder="Ex: 9mm ou .40" class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm uppercase">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase mb-2">Capacidade de Tiro</label>
                        <input type="text" name="capacidade_tiro" required placeholder="Ex: 17+1" class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm">
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase mb-2">Sistema de Funcionamento</label>
                        <input type="text" name="sistema_funcionamento" required placeholder="Ex: Semiautomática" class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm uppercase">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase mb-2">Qtd de Canos</label>
                        <input type="number" name="qtd_cano" required class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase mb-2">Comprimento do Cano</label>
                        <input type="text" name="comprimento_cano" required placeholder="Ex: 102mm" class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm uppercase">
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase mb-2">Tipo de Alma</label>
                        <input type="text" name="tipo_alma" required placeholder="Ex: Raiada" class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm uppercase">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase mb-2">Qtd de Raias</label>
                        <input type="number" name="qtd_raias" required class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase mb-2">Sentido das Raias</label>
                        <input type="text" name="sentido_raias" required placeholder="Ex: Direita" class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm uppercase">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="preco" required class="w-full p-3 pl-10 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm">
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase mb-2">Quantidade Atual</label>
                        <input type="number" name="quantidade" required class="w-full p-3 border-2 border-slate-100 rounded-lg focus:border-blue-900 outline-none font-bold text-sm">
                    </div>
                    <div>
