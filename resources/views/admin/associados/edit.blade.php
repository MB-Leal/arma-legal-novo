        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="rg_militar" value="{{ old('rg_militar', $associado->rg_militar) }}" class="w-full p-3 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-blue-900 outline-none font-bold text-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="opm" value="{{ old('opm', $associado->opm) }}" maxlength="10" class="w-full p-3 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-blue-900 outline-none font-bold text-sm uppercase">
                </div>

                <div>
                    <label class="block text-[10px] font-black text-slate-400 uppercase mb-2">E-mail</label>
                    <input type="email" name="email" value="{{ old('email', $associado->email) }}" class="w-full p-3 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-blue-900 outline-none font-bold text-sm">
                </div>
                <div>
                    <label class="block text-[10px] font-black text-slate-400 uppercase mb-2">Celular / WhatsApp</label>
                    <input type="text" name="celular" value="{{ old('celular', $associado->celular) }}" class="w-full p-3 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-blue-900 outline-none font-bold text-sm">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-4 gap-6">
                <div>
                    ...
                    <input type="text" name="cep" id="cep" value="{{ old('cep', $associado->endereco->cep ?? '') }}" maxlength="8" 
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="logradouro" id="logradouro" value="{{ old('logradouro', $associado->endereco->logradouro ?? '') }}" class="w-full p-3 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-blue-900 outline-none font-bold text-sm uppercase">
                </div>

                <div>
                    <label class="block text-[10px] font-black text-slate-400 uppercase mb-2">Número</label>
                    <input type="text" name="numero" value="{{ old('numero', $associado->endereco->numero ?? '') }}" class="w-full p-3 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-blue-900 outline-none font-bold text-sm">
                </div>

                <div>
                    <label class="block text-[10px] font-black text-slate-400 uppercase mb-2">Bairro</label>
                    <input type="text" name="bairro" id="bairro" value="{{ old('bairro', $associado->endereco->bairro ?? '') }}"  class="w-full p-3 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-blue-900 outline-none font-bold text-sm uppercase">
                </div>

                <div class="md:col-span-2">
                    <label class="block text-[10px] font-black text-slate-400 uppercase mb-2">Município / Cidade</label>
                    <input type="text" name="cidade" id="cidade" value="{{ old('cidade', $associado->endereco->cidade ?? '') }}"  class="w-full p-3 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-blue-900 outline-none font-bold text-sm uppercase">
                </div>

                <div>
                    <label class="block text-[10px] font-black text-slate-400 uppercase mb-2">Estado (UF)</label>
                    <input type="text" name="estado" id="estado" value="{{ old('estado', $associado->endereco->estado ?? '') }}" maxlength="2" class="w-full p-3 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-blue-900 outline-none font-bold text-sm uppercase">
                </div>
